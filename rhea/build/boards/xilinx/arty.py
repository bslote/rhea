...
class Arty(FPGA):
    ...
    default_clocks = {
        'clock': dict(frequency=100e6, pins=('E3',), iostandard='LVCMOS33')
    }
    ...
    default_ports = {
        ...
        'sw': dict(pins=('A8', 'C11', 'C10', 'A10'), iostandard='LVCMOS33'),
        ...
        'led': dict(pins=('H5', 'J5', 'T9', 'T10'), iostandard='LVCMOS33'),
        ...
        'btn': dict(pins=('D9', 'C9', 'B9', 'B8'), iostandard='LVCMOS33'),
        ...
        'uart_rxd_out': dict(pins=('D10',), iostandard='LVCMOS33'),
        'uart_txd_in': dict(pins=('A9',), iostandard='LVCMOS33'),
